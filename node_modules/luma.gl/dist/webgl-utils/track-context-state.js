...
var GL_STATE_SETTERS = {
  ...
  polygonOffset: function polygonOffset(setter, factor, units) {
    ...
    return setter((_setter20 = {}, _defineProperty(_setter20, _constants2.default.POLYGON_OFFSET_FACTOR, factor), _defineProperty(_setter20, _constants2.default.POLYGON_OFFSET_UNITS, units), _setter20));
  },

  sampleCoverage: function sampleCoverage(setter, value, invert) {
    var _setter21;

    return setter((_setter21 = {}, _defineProperty(_setter21, _constants2.default.SAMPLE_COVERAGE_VALUE, value), _defineProperty(_setter21, _constants2.default.SAMPLE_COVERAGE_INVERT, invert), _setter21));
  },
  ...
  stencilMask: function stencilMask(setter, mask) {
    ...
    return setter((_setter23 = {}, _defineProperty(_setter23, _constants2.default.STENCIL_WRITEMASK, mask), _defineProperty(_setter23, _constants2.default.STENCIL_BACK_WRITEMASK, mask), _setter23));
  },
  ...
  stencilFunc: function stencilFunc(setter, func, ref, mask) {
    ...
    return setter((_setter25 = {}, _defineProperty(_setter25, _constants2.default.STENCIL_FUNC, func), _defineProperty(_setter25, _constants2.default.STENCIL_REF, ref), _defineProperty(_setter25, _constants2.default.STENCIL_VALUE_MASK, mask), _defineProperty(_setter25, _constants2.default.STENCIL_BACK_FUNC, func), _defineProperty(_setter25, _constants2.default.STENCIL_BACK_REF, ref), _defineProperty(_setter25, _constants2.default.STENCIL_BACK_VALUE_MASK, mask), _setter25));
  },

  stencilFuncSeparate: function stencilFuncSeparate(setter, face, func, ref, mask) {
    var _setter26;

    return setter((_setter26 = {}, _defineProperty(_setter26, face === _constants2.default.FRONT ? _constants2.default.STENCIL_FUNC : _constants2.default.STENCIL_BACK_FUNC, func), _defineProperty(_setter26, face === _constants2.default.FRONT ? _constants2.default.STENCIL_REF : _constants2.default.STENCIL_BACK_REF, ref), _defineProperty(_setter26, face === _constants2.default.FRONT ? _constants2.default.STENCIL_VALUE_MASK : _constants2.default.STENCIL_BACK_VALUE_MASK, mask), _setter26));
  },

  stencilOp: function stencilOp(setter, fail, zfail, zpass) {
    var _setter27;

    return setter((_setter27 = {}, _defineProperty(_setter27, _constants2.default.STENCIL_FAIL, fail), _defineProperty(_setter27, _constants2.default.STENCIL_PASS_DEPTH_FAIL, zfail), _defineProperty(_setter27, _constants2.default.STENCIL_PASS_DEPTH_PASS, zpass), _defineProperty(_setter27, _constants2.default.STENCIL_BACK_FAIL, fail), _defineProperty(_setter27, _constants2.default.STENCIL_BACK_PASS_DEPTH_FAIL, zfail), _defineProperty(_setter27, _constants2.default.STENCIL_BACK_PASS_DEPTH_PASS, zpass), _setter27));
  },

  stencilOpSeparate: function stencilOpSeparate(setter, face, fail, zfail, zpass) {
    var _setter28;

    return setter((_setter28 = {}, _defineProperty(_setter28, face === _constants2.default.FRONT ? _constants2.default.STENCIL_FAIL : _constants2.default.STENCIL_BACK_FAIL, fail), _defineProperty(_setter28, face === _constants2.default.FRONT ? _constants2.default.STENCIL_PASS_DEPTH_FAIL : _constants2.default.STENCIL_BACK_PASS_DEPTH_FAIL, zfail), _defineProperty(_setter28, face === _constants2.default.FRONT ? _constants2.default.STENCIL_PASS_DEPTH_PASS : _constants2.default.STENCIL_BACK_PASS_DEPTH_PASS, zpass), _setter28));
  },
