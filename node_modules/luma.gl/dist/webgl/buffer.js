...
var Buffer = /*#__PURE__*/function (_Resource) {
  ...
  function Buffer(gl) {
    ...
    _this.target = opts.target || (_this.gl.webgl2 ? GL_COPY_READ_BUFFER : _api2.default.ARRAY_BUFFER);
    _this.index = null;
    _this.setData(opts);
    Object.seal(_this);
    return _this;
  ...
  _createClass(Buffer, [{
    ...
    value: function initialize() {
      var _ref3 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          ...
          usage = _ref3$usage === undefined ? _api2.default.STATIC_DRAW : _ref3$usage,
          layout = _ref3.layout,
          type = _ref3.type,
      ...
      if (!data) {
        ...
        (0, _assert2.default)(type, ERR_BUFFER_PARAMS);
      }
    ...
    value: function subData() {
      ...
      (0, _assert2.default)(data, ERR_BUFFER_PARAMS);
    ...
    value: function bind() {
      ...
      var type = target === _api2.default.UNIFORM_BUFFER || target === GL_TRANSFORM_FEEDBACK_BUFFER ? size !== undefined ? 'ranged' : ' indexed' : 'non-indexed';
      ...
      switch (type) {
        ...
        case 'indexed':
          (0, _context.assertWebGL2Context)(this.gl);
          (0, _assert2.default)(offset === 0, ERR_BUFFER_PARAMS); // Make sure offset wasn't supplied
    ...
    value: function unbind() {
      ...
      var isIndexedBuffer = target === _api2.default.UNIFORM_BUFFER || target === GL_TRANSFORM_FEEDBACK_BUFFER;
      if (isIndexedBuffer) {
