  ...
  _createClass(Framebuffer, [{
    ...
    value: function clear() {
      ...
      if (color || depth || stencil) {
        (0, _clear2.clear)({ color: color, depth: depth, stencil: stencil });
      }
    ...
    value: function copyToTexture(_ref8) {
      var srcFramebuffer = _ref8.srcFramebuffer,
          ...
          internalFormat = _ref8$internalFormat === undefined ? _api2.default.RGBA : _ref8$internalFormat,
    ...
    value: function blit(_ref9) {
      var srcFramebuffer = _ref9.srcFramebuffer,
          ...
          filter = _ref9$filter === undefined ? _api2.default.NEAREST : _ref9$filter;
      var gl = this.gl;
    ...
    value: function _createDefaultAttachments(_ref14) {
      ...
      if (depth) {
        defaultAttachments = defaultAttachments || {};
        defaultAttachments[GL_DEPTH_ATTACHMENT] = new _renderbuffer2.default(this.gl, {
          format: _api2.default.DEPTH_COMPONENT16,
          width: width,
          height: height
        });
      }
