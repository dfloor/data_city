...
var Model = /*#__PURE__*/function (_Object3D) {
  ...
  function Model(gl) {
    ...
    if ((0, _webgl.isWebGL)(gl)) {
      ...
      (0, _assert2.default)((0, _webgl.isWebGL)(_this.gl), 'Not a WebGL context');
    }
    _this.init(opts);
    return _this;
  }
  ...
  _createClass(Model, [{
    ...
    value: function _initializeProgram(_ref2) {
      ...
      if (vs === _shaders.MONOLITHIC_SHADERS.vs || fs === _shaders.MONOLITHIC_SHADERS.fs) {
        defaultUniforms = defaultUniforms || _shaders.MONOLITHIC_SHADERS.defaultUniforms;
      }
      ...
      this.program = program || new _webgl.Program(this.gl, { vs: vs, fs: fs });
    ...
    value: function draw() {
      ...
      return (0, _webgl.withParameters)(gl, parameters, function () {
    ...
    value: function _timerQueryEnd() {
      if (this.timerQueryEnabled === true) {
        ...
        if (this.timeElapsedQuery.isResultAvailable()) {
          ...
          _utils.log.log(2, 'last frame time: ' + this.stats.lastFrameTime + 'ms');
          _utils.log.log(2, 'average frame time ' + this.stats.averageFrameTime + 'ms');
          _utils.log.log(2, 'accumulated frame time: ' + this.stats.accumulatedFrameTime + 'ms');
          _utils.log.log(2, 'profile frame count: ' + this.stats.profileFrameCount);
        }
      }
    }
